...
This directory contains examples of the GABP session handshake process - the initial exchange between a bridge (client)
and mod (server) to establish a connection.
